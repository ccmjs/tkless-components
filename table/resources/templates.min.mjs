import{html,render,repeat}from"https://ccmjs.github.io/tkless-components/libs/lit/lit.js";export{render};export function main(app){const values=app.getValue()?.values;console.log(values);return html`
