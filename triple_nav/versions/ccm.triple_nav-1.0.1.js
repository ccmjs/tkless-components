 ...
 * @author Tea Kless <tea.kless@web.de> 2017-2022
      ...
      this.start = async () => {
        ...
        async function setUpDropdown( instance ) {
          ...
          $.prepend( instance.element.querySelector( 'ul' ), $.html(
            '<li class="dropdown">' +
            '  <a class="dropdown-toggle" role="button">'+ my.dropdown.title + ' <code>' + my.dropdown.entries[ 0 ] +'</code> <span class="caret"></span></a>' +
          ...
          [ ...instance.element.querySelectorAll( '.dropdown li' ) ].map( ( li, i ) => {
            li.addEventListener( 'click', ( event )=> {
              ...
              $.setContent( instance.element.querySelector( '.dropdown a' ), $.html(my.dropdown.title + ' <code>' + li.textContent + '</code><span class="caret"></span>') );
              renderContent();
            } )
          } );
