import{html,render}from"https://ccmjs.github.io/tkless-components/libs/lit/lit.js";export{render};export function main(app,onClick,navBars){return html`
    <header class="topnav">
      <div id="home">
  ...
  `}export function home(app,onClick){return html`
    ...
    `))}
  `}export function headline(title,section,entry){if(section)return html`
      <div>
        <div>${title}</div>
        <div>
    ...
    `;else return html`<div>${title}</div>`}
//# sourceMappingURL=templates-3.0.0.min.mjs.map