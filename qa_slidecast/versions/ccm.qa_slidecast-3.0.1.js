...
//    "onstart": instance => { console.log( 'start', instance.slide_nr ) },
      "open": "both",
      "pdf_viewer": [ "ccm.instance", "https://ccmjs.github.io/tkless-components/pdf_viewer/versions/ccm.pdf_viewer-7.3.0.min.js" ],
      ...
      const render = async skip => {
        ...
        switch ( typeof content ) {
          case 'number':
            ...
            $.append( slide_element, '<div id="text-layer"></div>' );
