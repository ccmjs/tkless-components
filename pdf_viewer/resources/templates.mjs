    ...
    <main>
      ...
      <div>
        <nav id="controls" ?data-hidden=${ pages <= 1 }>
          <div title="${ instance.text.first }" ?data-disabled=${ page_nr === 1 } @click=${ events.onFirst }>
          ...
          <div title="${ instance.text.prev }" ?data-disabled=${ page_nr === 1 } @click=${ events.onPrev }>
            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 16 16">
          ...
          <div title="${ instance.text.next }" ?data-disabled=${ page_nr === pages } @click=${ events.onNext }>
            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 16 16">
              <path d="M6 12.796V3.204L11.481 8 6 12.796zm.659.753 5.48-4.796a1 1 0 0 0 0-1.506L6.66 2.451C6.011 1.885 5 2.345 5 3.204v9.592a1 1 0 0 0 1.659.753z"/>
            </svg>
          </div>
          <div title="${ instance.text.last }" ?data-disabled=${ page_nr === pages } @click=${ events.onLast }>
            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 16 16">
