    ...
    <main>
      ...
      <div>
        <nav id="controls" ?data-hidden=${ pages <= 1 }>
          <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 16 16" ?data-disabled=${ page_nr === 1 } @click=${ events.onFirst }>
          ...
          <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 16 16" ?data-disabled=${ page_nr === 1 } @click=${ events.onPrev }>
            <path d="M10 12.796V3.204L4.519 8 10 12.796zm-.659.753-5.48-4.796a1 1 0 0 1 0-1.506l5.48-4.796A1 1 0 0 1 11 3.204v9.592a1 1 0 0 1-1.659.753z"/>
          </svg>
          <div>
            <input type="text" size="${ pages.toString().length }" placeholder="${ page_nr } / ${ pages }" @change=${ events.onJump }>
          </div>
          <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 16 16" ?data-disabled=${ page_nr === pages } @click=${ events.onNext }>
            <path d="M6 12.796V3.204L11.481 8 6 12.796zm.659.753 5.48-4.796a1 1 0 0 0 0-1.506L6.66 2.451C6.011 1.885 5 2.345 5 3.204v9.592a1 1 0 0 0 1.659.753z"/>
          </svg>
          <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 16 16" ?data-disabled=${ page_nr === pages } @click=${ events.onLast }>
        ...
        <nav id="extra">
          <a href="${ instance.pdf }" download target="_blank" ?data-hidden=${ !instance.downloadable }>
