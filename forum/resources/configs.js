ccm.files[ 'configs.js' ] = {
  'demo': {
    ...
    user:  [ 'ccm.instance', 'https://ccmjs.github.io/akless-components/user/ccm.user.js', { 'sign_on': 'demo'} ],
    ...
    question: [ 'ccm.component', 'https://ccmjs.github.io/tkless-components/question/versions/ccm.question-1.0.0.js', {
      ...
      user:  [ 'ccm.instance', 'https://ccmjs.github.io/akless-components/user/ccm.user.js', { logged_in: true, 'sign_on': 'demo'} ],
